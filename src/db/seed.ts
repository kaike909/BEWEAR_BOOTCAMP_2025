...
const products = [
    ...
    },
    {
        ...
        description:
            "Jaqueta Nike Club com qualidade premium e design atemporal.",
        categoryName: "Jaquetas & Moletons",
        variants: [
    ...
    },
    {
        ...
        description:
            "Tênis Nike com design Panda icônico, confortável e estiloso.",
        categoryName: "Tênis",
        variants: [
    ...
    try {
        ...
        for (const productData of products) {
            ...
            for (const variantData of productData.variants) {
                ...
                const productKey =
                    productData.name as keyof typeof productImages;
                const variantImages =
                ...
                await db.insert(productVariantTable).values({
                    ...
                    slug: generateSlug(
                        `${productData.name}-${variantData.color}`
                    ),
                });
            }
        }
